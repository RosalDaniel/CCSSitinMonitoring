...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_stmt = $conn->prepare("UPDATE student SET firstname = ?, middlename = ?, lastname = ?, course = ?, year = ?, email = ?, sessions = ?, address = ? WHERE idno = ?");
    $update_stmt->bind_param("ssssssisi", $firstname, $middlename, $lastname, $course, $year, $email, $sessions, $address, $id);
...
<div class="container">
    ...
    <form method="POST" action="editstudent.php">
        ...
        <input type="text" value="<?= htmlspecialchars($student['idno']); ?>" disabled>
        ...
        <input type="number" name="sessions" value="<?= htmlspecialchars($student['sessions']); ?>" required>
        <label>Address:</label>
